...
import com.souzip.application.location.dto.PlaceSearchResult;  // ← 추가
import com.souzip.application.location.dto.SearchPlace;  // ← 추가
...
import com.souzip.application.location.required.PlaceSearchProvider;  // ← 추가
