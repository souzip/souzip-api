...
class ExchangeControllerTest extends RestDocsSupport {
    ...
    private ExchangeRateResponseDto createResponse(String base, String currency, BigDecimal rate) {
        return new ExchangeRateResponseDto(base, currency, rate);
    }
    ...
    void getRateByCountry() throws Exception {
        // given
        ExchangeRateResponseDto usd =
                createResponse("KRW", "USD", BigDecimal.valueOf(1300));
        ...
        mockMvc.perform(get("/api/exchange-rate/{countryCode}", "US"))
                ...
                .andExpect(jsonPath("$.baseCode").value("KRW"))
                .andExpect(jsonPath("$.currencyCode").value("USD"))
                .andExpect(jsonPath("$.rate").value(1300))
                .andDo(document("exchange-rate/get-by-country",
                        ...
                        apiResponseFields(
                                ...
                                fieldWithPath("rate").type(JsonFieldType.NUMBER).description("환율"),
    ...
    void getRatesByCountries() throws Exception {
        ...
        ExchangeRateResponseDto usd =
                createResponse("KRW", "USD", BigDecimal.valueOf(1300));
        ExchangeRateResponseDto jpy =
                createResponse("KRW", "JPY", BigDecimal.valueOf(9));
        ...
        mockMvc.perform(get("/api/exchange-rate")
                ...
                .andExpect(jsonPath("$[1].currencyCode").value("JPY"))
    ...
    void getAllRates() throws Exception {
        ...
        ExchangeRateResponseDto jpy =
                createResponse("KRW", "JPY", BigDecimal.valueOf(9));
        ExchangeRateResponseDto eur =
                createResponse("KRW", "EUR", BigDecimal.valueOf(1500));
        ...
        mockMvc.perform(get("/api/exchange-rate"))
                .andDo(print())
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[2].currencyCode").value("EUR"))
