...
class GeneralRecommendationControllerTest extends RestDocsSupport {
    ...
    void getCategoryTop10() throws Exception {
        ...
        given(generalRecommendationService.getTop10ByCategory("FOOD_SNACK", null))
        ...
        mockMvc.perform(get("/api/discovery/general/category/{categoryName}", "FOOD_SNACK"))
                ...
                .andDo(document("recommend/category-top10",
                        ...
                        apiResponseFields(
                                ...
                                fieldWithPath("data[].isWishlisted").type(JsonFieldType.BOOLEAN).description("찜 여부 (비로그인 시 null)").optional(),
    ...
    void getCountryTop10() throws Exception {
        ...
        given(generalRecommendationService.getTop10ByCountry("KR", null))
                .willReturn(responseList);
    ...
    void getTopCountriesWithTop10Souvenirs() throws Exception {
        ...
        given(generalRecommendationService.getTopCountriesWithTop10Souvenirs(null))
                .willReturn(response);
        ...
        mockMvc.perform(get("/api/countries/souvenirs"))
                ...
                .andDo(document("recommend/countries-top10-souvenirs-top10",
                        ...
                        apiResponseFields(
                                ...
                                fieldWithPath("data[].souvenirs[].isWishlisted").type(JsonFieldType.BOOLEAN).description("찜 여부 (비로그인 시 null)").optional(),
                                fieldWithPath("message").type(JsonFieldType.STRING).description("응답 메시지").optional()
                        )
                ));
    }
